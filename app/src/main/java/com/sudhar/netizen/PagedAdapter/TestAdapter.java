...
public class TestAdapter extends PagingDataAdapter<Comment, TestAdapter.FullCommentVH> {
    ...
    public interface ReplyButtonListener {
        void OnReplyButtonClick(ViewerCommentAdapter commentAdapter, String ParentId, String Username, String Body);
    }


    public TestAdapter(Context context) {
        super(Comment.CALLBACK);
        ...
        public FullCommentVH(@NonNull View itemView) {
            ...
            mCommentRepliesViewBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (mRepliesRV.getVisibility() == View.GONE) {
                        ...
                        mRepliesRV.setLayoutManager(new LinearLayoutManager(context));
                        Comment commentEntity = getItem(getLayoutPosition());


                        Call<PagedResponse<Comment>> call = RetrofitClient.getClient(context).create(RestInterface.class).getComments(null, null, "meme", "7f6bff24-cbcd-412f-9b64-f16c3f8f21fe", commentEntity.getId());
                        ...
                        call.enqueue(new Callback<PagedResponse<Comment>>() {
                            ...
                            public void onResponse(Call<PagedResponse<Comment>> call, Response<PagedResponse<Comment>> response) {
                                ...
                                List<Comment> comments = response.body().getResults();

                                ViewerCommentAdapter commentAdapter = new ViewerCommentAdapter(context, comments);
            ...
            mCommentReplyBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String CommentId = getItem(position).getId();

                    replyButtonListener.OnReplyButtonClick((ViewerCommentAdapter) mRepliesRV.getAdapter(), CommentId, Username, Body);
                }
            });
